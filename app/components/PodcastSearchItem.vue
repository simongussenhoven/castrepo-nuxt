        ...
        <div class="flex gap-4">
            ...
            <div class="flex-shrink-0">
                <img :src="podcast.image || podcast.artwork" :alt="podcast.title"
                    class="w-16 h-16 rounded-lg object-cover bg-gray-200" @error="handleImageError" />
            </div>
            ...
            <div class="flex-1 min-w-0">
                <div class="flex justify-between items-start mb-2">
                    ...
                    <UBadge v-if="podcast.explicit" color="warning" variant="soft" size="xs" class="ml-2 flex-shrink-0">
                        Explicit
                    </UBadge>
                </div>
...
const handleImageError = (event: Event) => {
    ...
    target.src = '/placeholder-podcast.png' // Fallback image
}
